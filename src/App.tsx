...
function SanadAppContent() {
  ...
  return (
    <div 
      className="min-h-screen bg-slate-50/70 text-slate-800 flex flex-col font-sans selection:bg-emerald-200 selection:text-emerald-950" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="col-span-1 md:col-span-4 space-y-4">
              <h4 className="text-sm font-extrabold text-slate-900 tracking-wider">{t.footer_pages_title}</h4>
